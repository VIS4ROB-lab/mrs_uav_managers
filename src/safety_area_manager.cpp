...
class SafetyAreaManager : public mrs_lib::Node {
 ...
 private:
  ...
  struct VisualizationComponents {
    std::vector<std::unique_ptr<mrs_lib::StaticEdgesVisualization>>
        static_edges;

    void safeCleanup() { static_edges.clear(); }
  };
  ...
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::ReferenceStampedSrv>
      ss_point_in_safety_area_3d_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::ReferenceStampedSrv>
      ss_point_in_safety_area_2d_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::ValidatePathToPointSrv>
      ss_path_in_safety_area_3d_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::ValidatePathToPointSrv>
      ss_path_in_safety_area_2d_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::SetSafetyBorderSrv>
      ss_set_safety_border_;
  ...
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetReferenceStampedSrv>
      ss_get_max_z_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetReferenceStampedSrv>
      ss_get_min_z_;
  mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetBoolSrv>
  ...
  mrs_lib::PublisherHandler<mrs_msgs::msg::SafetyAreaManagerDiagnostics>
      ph_diagnostics_;
  ...
  bool callbackValidatePoint3d(
      ...
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
          response);
  bool callbackValidatePoint2d(
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
          response);
  bool callbackValidatePathToPoint3d(
      const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Response>
          response);
  bool callbackValidatePathToPoint2d(
      const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Response>
          response);

  bool callbackSetSafetyBorder(
      const std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Request> request,
      const std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Response>
          response);
  bool callbackToggleSafetyArea(
      const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
      const std::shared_ptr<std_srvs::srv::SetBool::Response> response);
  bool callbackAddObstacle(
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
          response);
  bool callbackSetObstacle(
      const std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Request> request,
      const std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Response> response);
  bool callbackGetMaxZ(
      const std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
          response);
  bool callbackGetMinZ(
      ...
      const std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
          response);
  bool callbackIsSafetyZoneEnabled(
      [[maybe_unused]] const std::shared_ptr<mrs_msgs::srv::GetBoolSrv::Request>
          request,
      std::shared_ptr<mrs_msgs::srv::GetBoolSrv::Response> response);
  bool callbackUpdateWorldOrigin(
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
          request,
      const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
          response);
  ...
  std::unique_ptr<mrs_lib::safety_zone::Prism> makePrism(
      const Eigen::MatrixXd& matrix, const double max_z, const double min_z,
      const std::string& horizontal_frame, const std::string& vertical_frame);
  std::unique_ptr<mrs_lib::safety_zone::Prism> makePrism(
      const std::vector<mrs_msgs::msg::Point2D>& points, const double max_z,
      const double min_z, const std::string& horizontal_frame,
      const std::string& vertical_frame);
  // Transform prism
  mrs_lib::safety_zone::Prism transformPrism(mrs_lib::safety_zone::Prism& prism,
                                             const std::string& target_frame);

  std::tuple<bool, std::vector<mrs_lib::safety_zone::Point2d>> transformPoints(
      const std::vector<mrs_lib::safety_zone::Point2d>& points,
      const std::string& from_frame, const std::string& target_frame);

  std::tuple<bool, double> transformZ(const std::string& current_frame,
                                      const std::string& target_frame,
                                      const double z);
  bool initializationFromFile(mrs_lib::ParamLoader& param_loader,
                              const std::string& filename);
  std::vector<std::unique_ptr<mrs_lib::safety_zone::Prism>>
  copyExistingObstacles();
  bool initializationFromMsg(const mrs_msgs::msg::Prism& prism_msg,
                             bool keep_obstacles);
  std::optional<SafetyZoneHandler> createSafetyZone(
      std::unique_ptr<mrs_lib::safety_zone::Prism>&& border,
      std::vector<std::unique_ptr<mrs_lib::safety_zone::Prism>>
          obstacle_prisms);

  std::tuple<bool, std::string> validateMsg(
      const mrs_msgs::msg::Prism& prism_msg);
...
SafetyAreaManager::SafetyAreaManager(rclcpp::NodeOptions options)
    : mrs_lib::Node("safety_area_manager", options) {
  node_ = this_node_ptr();
  ...
  sh_gnss_ = mrs_lib::SubscriberHandler<sensor_msgs::msg::NavSatFix>(
      shopts, "~/gnss_in", &SafetyAreaManager::callbackGNSS, this);
  sh_control_manager_diag_ =
      mrs_lib::SubscriberHandler<mrs_msgs::msg::ControlManagerDiagnostics>(
          shopts, "~/control_manager_diagnostics_in");

  timer_prerequisites_ = node_->create_wall_timer(
      std::chrono::duration<double>(1.0),
      std::bind(&SafetyAreaManager::timerPrerequisites, this));
}
...
void SafetyAreaManager::initialize() {
  ...
  const std::string scope_timer_log_filename =
      param_loader.loadParam2("scope_timer/log_filename", std::string(""));
  ...
  if (!success) {
    RCLCPP_ERROR(node_->get_logger(),
                 "Failed to initialize safety area from file");
    rclcpp::shutdown();
    exit(1);
  }
  ...
  sh_odometry_ = mrs_lib::SubscriberHandler<nav_msgs::msg::Odometry>(
      shopts, "~/odometry_in", &SafetyAreaManager::callbackOdometry, this);
  ...
  ss_point_in_safety_area_3d_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::ReferenceStampedSrv>(
          ...
          [this](std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
                     request,
                 std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
                     response) { callbackValidatePoint3d(request, response); },
  ...
  ss_point_in_safety_area_2d_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::ReferenceStampedSrv>(
          ...
          [this](std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
                     request,
                 std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
                     response) { callbackValidatePoint2d(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ...
  ss_path_in_safety_area_3d_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::ValidatePathToPointSrv>(
          ...
          [this](
              std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Request>
                  request,
              std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Response>
                  response) {
  ...
  ss_set_safety_border_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::SetSafetyBorderSrv>(
          ...
          [this](std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Request>
                     request,
                 std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Response>
                     response) { callbackSetSafetyBorder(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_toggle_safety_area_ =
  ...
  ss_add_obstacle_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::ReferenceStampedSrv>(
          ...
          [this](std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request>
                     request,
                 std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
                     response) { callbackAddObstacle(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);

  ss_set_obstacle_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::SetObstacleSrv>(
          node_, "~/set_obstacle_in",
          [this](
              std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Request> request,
              std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Response>
                  response) { callbackSetObstacle(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ...
  ss_get_max_z_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetReferenceStampedSrv>(
          node_, "~/get_max_z_in",
          [this](
              std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Request>
                  request,
              std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
                  response) { callbackGetMaxZ(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
      ...
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetReferenceStampedSrv>(
          ...
          [this](
              std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Request>
                  request,
              std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
                  response) { callbackGetMinZ(request, response); },
          rclcpp::SystemDefaultsQoS(), cbkgrp_ss_);
  ...
  ss_is_safety_zone_enabled_ =
      mrs_lib::ServiceServerHandler<mrs_msgs::srv::GetBoolSrv>(
          ...
          [this](
              std::shared_ptr<mrs_msgs::srv::GetBoolSrv::Request> request,
              std::shared_ptr<mrs_msgs::srv::GetBoolSrv::Response> response) {
...

  {
    std::function<void()> callback_fcn =
        std::bind(&SafetyAreaManager::timerStatus, this);

    timer_status_ = std::make_shared<TimerType>(
        timer_opts_start, rclcpp::Rate(status_timer_rate_), callback_fcn);
  }
...
void SafetyAreaManager::timerPrerequisites() {
  mrs_lib::Routine profiler_routine =
      profiler_.createRoutine("timerPrerequisites");
  ...
  if (!got_hw_api_capabilities) {
    RCLCPP_WARN(node_->get_logger(), "waiting for data: HW Api=%s",
...
void SafetyAreaManager::timerStatus() {
  ...
  mrs_lib::ScopeTimer timer =
      mrs_lib::ScopeTimer(node_, "SafetyAreaManager::timerStatus",
                          scope_timer_logger_, scope_timer_enabled_);
  ...
  if (world_origin_changed_ &&
      current_border.getHorizontalFrame() == "world_origin") {
    RCLCPP_INFO(
        node_->get_logger(),
        "World origin has changed, updating the safety area accordingly.");
    ...
    for (auto& point : current_points) {
      new_points.push_back(mrs_lib::safety_zone::Point2d{
          point.get<0>() + world_origin_offset_x_,
          point.get<1>() + world_origin_offset_y_});
    }

    auto new_border_prism = std::make_unique<mrs_lib::safety_zone::Prism>(
        new_points, current_max_z, current_min_z, "world_origin",
        "world_origin");
    ...
    for (auto& obstacle : existing_obstacles) {
      if (obstacle->getHorizontalFrame() == "world_origin") {
        ...
        for (auto& point : obstacle_points) {
          updated_points.push_back(mrs_lib::safety_zone::Point2d{
              point.get<0>() + world_origin_offset_x_,
              point.get<1>() + world_origin_offset_y_});
        }

        *obstacle = mrs_lib::safety_zone::Prism(
            updated_points, obstacle->getMaxZ(), obstacle->getMinZ(),
            "world_origin", "world_origin");
      }
    }

    auto new_safety_zone = createSafetyZone(std::move(new_border_prism),
                                            std::move(existing_obstacles));
    ...
    if (new_safety_zone) {
      ...
      RCLCPP_ERROR(node_->get_logger(),
                   "Failed to update safety area after world origin change.");
    }
...
void SafetyAreaManager::callbackOdometry(
  ...
  mrs_lib::ScopeTimer timer =
      mrs_lib::ScopeTimer(node_, "SafetyAreaManager::callbackOdometry",
                          scope_timer_logger_, scope_timer_enabled_);
...
void SafetyAreaManager::callbackGNSS(
    const sensor_msgs::msg::NavSatFix::ConstSharedPtr msg) {
  mrs_lib::Routine profiler_routine = profiler_.createRoutine("callbackGNSS");
  mrs_lib::ScopeTimer timer =
      mrs_lib::ScopeTimer(node_, "SafetyAreaManager::callbackGNSS",
                          scope_timer_logger_, scope_timer_enabled_);
...
bool SafetyAreaManager::callbackAddObstacle(
  ...
  if (!is_initialized_) {
    ...
    RCLCPP_WARN(node_->get_logger(),
                "Service request not possible, not initialized");
    return true;
  }
...
bool SafetyAreaManager::callbackSetObstacle(
    const std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Request> request,
    const std::shared_ptr<mrs_msgs::srv::SetObstacleSrv::Response> response) {
  if (!is_initialized_) {
    response->message = "not initialized";
  ...
  if (!valid) {
    RCLCPP_WARN(node_->get_logger(), "Service request invalid: %s",
                message.c_str());
  ...
  safety_zone_handler_.visualization_components.static_edges.push_back(
      std::make_unique<mrs_lib::StaticEdgesVisualization>(
          safety_zone_handler_.safety_zone.get(), id, _uav_name_,
          request->prism.horizontal_frame, node_, 2));
...
bool SafetyAreaManager::callbackToggleSafetyArea(
    const std::shared_ptr<std_srvs::srv::SetBool::Request> request,
    const std::shared_ptr<std_srvs::srv::SetBool::Response> response) {
  if (!is_initialized_) {
    return false;
  ...
  response->message = "safety area usage has been turned " +
                      std::string((request->data ? "on" : "off"));
  response->success = true;
  RCLCPP_INFO(node_->get_logger(), "safety area usage has been turned %s",
              (request->data ? "on" : "off"));
  return true;
}
...
bool SafetyAreaManager::callbackSetSafetyBorder(
    const std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Request> request,
    const std::shared_ptr<mrs_msgs::srv::SetSafetyBorderSrv::Response>
        response) {
  if (!is_initialized_) {
  ...
  if (!sh_control_manager_diag_.hasMsg()) {
    RCLCPP_WARN(node_->get_logger(),
                "No control manager diagnostics received yet.");
  ...
  if (control_manager_diagnostics->tracker_status.have_goal) {
    RCLCPP_WARN(node_->get_logger(),
                "Can only modify safety area in IDLE state.");
  ...
  if (request->update_world_origin) {
    ...
    if (!sh_gnss_.hasMsg() ||
        !sh_hw_api_capabilities_.getMsg()->produces_gnss) {
      RCLCPP_WARN(node_->get_logger(),
                  "No GNSS fix available, cannot update world origin.");
      response->success = false;
    ...
    // Transform to latlon
    if (safety_zone_handler_.safety_zone->getBorder().getHorizontalFrame() !=
        "latlon_origin") {
      geometry_msgs::msg::PointStamped point_in_border_frame,
          point_in_latlon_frame;

      point_in_border_frame.header.frame_id =
          safety_zone_handler_.safety_zone->getBorder().getHorizontalFrame();
      ...
      auto tfed_point =
          transformer_->transformSingle(point_in_border_frame, "latlon_origin");

      if (!tfed_point) {
        RCLCPP_WARN(
            node_->get_logger(),
            "Could not transform border center to latlon_origin frame.");
        response->success = false;
        response->message =
            "Could not transform border center to latlon_origin frame.";
        return true;
    ...
    RCLCPP_INFO(
        node_->get_logger(), "Updating world origin to lat: %.6f lon: %.6f",
        ref_request->reference.position.x, ref_request->reference.position.y);

    auto res = sc_set_world_origin_.callAsync(ref_request);

    if (!res.has_value()) {
      RCLCPP_WARN(node_->get_logger(),
                  "Could not call EstimationManager set_world_origin service.");
      response->success = false;
      response->message =
          "Could not call EstimationManager set_world_origin service.";
      return true;
  ...
  RCLCPP_INFO(node_->get_logger(), "New safety border, with %lu vertices.",
              request->prism.points.size());
...
bool SafetyAreaManager::callbackValidatePoint3d(
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request> request,
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
        response) {
  if (!is_initialized_) {
...
bool SafetyAreaManager::callbackValidatePoint2d(
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request> request,
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
        response) {
  if (!is_initialized_) {
...
bool SafetyAreaManager::callbackValidatePathToPoint3d(
    const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Request>
        request,
    const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Response>
        response) {
...
bool SafetyAreaManager::callbackValidatePathToPoint2d(
    const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Request>
        request,
    const std::shared_ptr<mrs_msgs::srv::ValidatePathToPointSrv::Response>
        response) {
...
bool SafetyAreaManager::callbackGetMaxZ(
    [[maybe_unused]] const std::shared_ptr<
        mrs_msgs::srv::GetReferenceStampedSrv::Request>
        request,
    const std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
        response) {
  if (!is_initialized_) {
  ...
  auto max_z = getMaxZ();
  response->reference.header.frame_id =
      safety_zone_handler_.safety_zone->getBorder().getVerticalFrame();
...
bool SafetyAreaManager::callbackGetMinZ(
    [[maybe_unused]] const std::shared_ptr<
        mrs_msgs::srv::GetReferenceStampedSrv::Request>
        request,
    const std::shared_ptr<mrs_msgs::srv::GetReferenceStampedSrv::Response>
...
bool SafetyAreaManager::callbackIsSafetyZoneEnabled(
    [[maybe_unused]] const std::shared_ptr<mrs_msgs::srv::GetBoolSrv::Request>
        request,
...
bool SafetyAreaManager::callbackUpdateWorldOrigin(
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Request> request,
    const std::shared_ptr<mrs_msgs::srv::ReferenceStampedSrv::Response>
        response) {
  if (!is_initialized_) {
  ...
  double dLat = (request->reference.position.x -
                 safety_zone_handler_.parameters.world_origin.x) *
                p;
  double dLon = (request->reference.position.y -
                 safety_zone_handler_.parameters.world_origin.y) *
                p;

  // Haversine distance
  double a = std::sin(dLat / 2) * std::sin(dLat / 2) +
             std::cos(lat1_rad) * std::cos(lat2_rad) * std::sin(dLon / 2) *
                 std::sin(dLon / 2);
  ...
  RCLCPP_INFO(node_->get_logger(),
              "World origin shifted by dx: %.2f dy: %.2f meters", delta_x,
              delta_y);

  safety_zone_handler_.parameters.world_origin.x =
      request->reference.position.x;
  safety_zone_handler_.parameters.world_origin.y =
      request->reference.position.y;
  safety_zone_handler_.parameters.world_origin.units =
      (request->header.frame_id.find("latlon_origin") != std::string::npos)
          ? "LATLON"
          : "UTM";
...
bool SafetyAreaManager::initializationFromFile(
    mrs_lib::ParamLoader& param_loader, const std::string& filename) {
  ...
  param_loader.loadParam(
      "mrs_uav_managers/safety_area_manager/safety_area/enabled",
      safety_area_enabled);
  param_loader.loadParam(
      "mrs_uav_managers/safety_area_manager/safety_area/horizontal/frame_name",
      horizontal_frame);
  param_loader.loadParam(
      "mrs_uav_managers/safety_area_manager/safety_area/vertical/frame_name",
      vertical_frame);

  if (!param_loader.loadedSuccessfully()) {
    RCLCPP_ERROR(node_->get_logger(),
                 "could not load world config parameters!");
    rclcpp::shutdown();
    exit(1);
  }

  // Make border prism
  const Eigen::MatrixXd border_points = param_loader.loadMatrixDynamic2(
      "mrs_uav_managers/safety_area_manager/safety_area/horizontal/points", -1,
      2);
  const auto max_z = param_loader.loadParam2<double>(
      "mrs_uav_managers/safety_area_manager/safety_area/vertical/max_z");
  const auto min_z = param_loader.loadParam2<double>(
      "mrs_uav_managers/safety_area_manager/safety_area/vertical/min_z");

  if (!param_loader.loadedSuccessfully()) {
    RCLCPP_ERROR(node_->get_logger(),
                 "could not load safety area border parameters!");
    return false;
  }

  auto border =
      makePrism(border_points, max_z, min_z, horizontal_frame, vertical_frame);
  ...
  param_loader.loadParam(
      "mrs_uav_managers/safety_area_manager/safety_area/obstacles/present",
      obstacles_present);
  ...
  if (obstacles_present) {
    ...
    param_loader.loadParam(
        "mrs_uav_managers/safety_area_manager/obstacles/count",
        obstacles_count);
    ...
    for (int i = 0; i < obstacles_count; i++) {
      ...
      std::string obstacle_path =
          "mrs_uav_managers/safety_area_manager/obstacles/obstacle_" +
          std::to_string(i);

      std::string points_path = obstacle_path + "/horizontal/points";
      Eigen::MatrixXd obstacle =
          param_loader.loadMatrixDynamic2(points_path, -1, 2);

      std::string horizontal_frame_path =
          obstacle_path + "/horizontal/frame_name";
      ...
      if (!param_loader.loadedSuccessfully()) {
        RCLCPP_ERROR(node_->get_logger(),
                     "could not load safety area obstacle %d parameters!", i);
        return false;
      }

      // Make obstacle prism
      auto prism =
          makePrism(obstacle, max_z, min_z, horizontal_frame, vertical_frame);

      if (!prism) {
        RCLCPP_WARN(node_->get_logger(), "Failed to create obstacle prism %d!",
                    i);
        return false;
      }
...
std::vector<std::unique_ptr<mrs_lib::safety_zone::Prism>>
SafetyAreaManager::copyExistingObstacles() {
  if (!safety_zone_handler_.safety_zone) {
    return {};
  }
  ...
  for (const auto& [id, obstacle_ptr] : obstacles_map) {
    obstacles_copy.push_back(
        std::make_unique<mrs_lib::safety_zone::Prism>(*obstacle_ptr));
  }

  return obstacles_copy;
}

bool SafetyAreaManager::initializationFromMsg(
    const mrs_msgs::msg::Prism& prism_msg, bool keep_obstacles) {
  auto [res, message] = validateMsg(prism_msg);

  if (!res) {
    RCLCPP_WARN(node_->get_logger(), "Message not valid, error message: %s",
                message.c_str());
    return false;
  }

  // Make border prism
  auto border = makePrism(prism_msg.points, prism_msg.max_z, prism_msg.min_z,
                          prism_msg.horizontal_frame, prism_msg.vertical_frame);
  ...
  auto new_safety_zone =
      keep_obstacles
          ? createSafetyZone(std::move(border), copyExistingObstacles())
          : createSafetyZone(std::move(border), {});
...
SafetyAreaManager::createSafetyZone(
    std::unique_ptr<mrs_lib::safety_zone::Prism>&& border,
    std::vector<std::unique_ptr<mrs_lib::safety_zone::Prism>> obstacle_prisms =
        {}) {
  SafetyZoneHandler safety_zone_handler;
  safety_zone_handler.safety_zone =
      std::make_shared<mrs_lib::safety_zone::SafetyZone>(
          std::move(border), std::move(obstacle_prisms));
  ...
  safety_zone_handler.visualization_components.static_edges.push_back(
      std::make_unique<mrs_lib::StaticEdgesVisualization>(
          transformed_prism, _uav_name_, "local_origin", node_, 2));
  ...
  for (const auto& [id, obstacle_ptr] : obstacles) {
    ...
    auto transformed_obstacle_prism =
        transformPrism(*obstacle_ptr, "local_origin");
    safety_zone_handler.visualization_components.static_edges.push_back(
        std::make_unique<mrs_lib::StaticEdgesVisualization>(
            transformed_obstacle_prism, _uav_name_, "local_origin", node_, 2));
  }
...
std::tuple<bool, std::string> SafetyAreaManager::validateMsg(
    const mrs_msgs::msg::Prism& prism_msg) {
  ...
  if (prism_msg.horizontal_frame.empty() || prism_msg.vertical_frame.empty()) {
    return std::make_tuple(
        false, "Frame units (horizontal_frame and vertical_frame) are empty");
  }
...
std::unique_ptr<mrs_lib::safety_zone::Prism> SafetyAreaManager::makePrism(
    const Eigen::MatrixXd& matrix, const double max_z, const double min_z,
    const std::string& horizontal_frame, const std::string& vertical_frame) {
  if (matrix.rows() < 3) {
    RCLCPP_WARN(node_->get_logger(),
                "Invalid polygon, must have at least 3 points. Provided:  %zu",
                matrix.rows());
  }
  ...
  for (int i = 0; i < matrix.rows(); i++) {
    points.emplace_back(
        mrs_lib::safety_zone::Point2d{matrix(i, 0), matrix(i, 1)});
  }

  auto prism = std::make_unique<mrs_lib::safety_zone::Prism>(
      points, max_z, min_z, horizontal_frame, vertical_frame);
...
std::unique_ptr<mrs_lib::safety_zone::Prism> SafetyAreaManager::makePrism(
  ...
  auto prism = std::make_unique<mrs_lib::safety_zone::Prism>(
      tmp_points, max_z, min_z, horizontal_frame, vertical_frame);
...
mrs_lib::safety_zone::Prism SafetyAreaManager::transformPrism(
    mrs_lib::safety_zone::Prism& prism, const std::string& target_frame) {
  auto border_points = prism.getPoints();
  auto [success, transformed_border_points] =
      transformPoints(border_points, prism.getHorizontalFrame(), target_frame);
  // transform max_z and min_z
  auto [z_success_max, transformed_max_z] =
      transformZ(prism.getVerticalFrame(), target_frame, prism.getMaxZ());
  auto [z_success_min, transformed_min_z] =
      transformZ(prism.getVerticalFrame(), target_frame, prism.getMinZ());

  if (!success || !z_success_max || !z_success_min) {
    RCLCPP_WARN(node_->get_logger(),
                "Failed to transform safety border points to %s frame.",
                target_frame.c_str());
    return prism;
  }

  return mrs_lib::safety_zone::Prism(transformed_border_points,
                                     transformed_max_z, transformed_min_z,
...
SafetyAreaManager::transformPoints(
    const std::vector<mrs_lib::safety_zone::Point2d>& points,
    const std::string& from_frame, const std::string& target_frame) {
  ...
  for (const auto& point : points) {
    ...
    if (auto transformed_reference =
            transformer_->transformSingle(reference_tmp, target_frame)) {
      reference_tmp = transformed_reference.value();
      transformed_points.emplace_back(
          mrs_lib::safety_zone::Point2d{reference_tmp.reference.position.x,
                                        reference_tmp.reference.position.y});
    } else {
      RCLCPP_WARN(node_->get_logger(),
                  "Could not transform point from %s to %s.",
                  from_frame.c_str(), target_frame.c_str());
      return std::make_tuple(false,
                             std::vector<mrs_lib::safety_zone::Point2d>{});
    }
  }
...
std::tuple<bool, double> SafetyAreaManager::transformZ(
    const std::string& current_frame, const std::string& target_frame,
    const double z) {
  ...
  const auto res =
      transformer_->transformSingle(current_frame, point, target_frame);

  if (!res) {
    RCLCPP_WARN(node_->get_logger(), "Could not transform point from %s to %s.",
                current_frame.c_str(), target_frame.c_str());
...
bool SafetyAreaManager::isPointInSafetyArea2d(
  ...
  if (!safety_zone_handler_.safety_zone->isPointValid(
...
bool SafetyAreaManager::isPointInSafetyArea3d(
    const mrs_msgs::msg::ReferenceStamped& point) {
  std::scoped_lock lock(mutex_safety_area_);
...
bool SafetyAreaManager::isPathToPointInSafetyArea2d(
  ...
  std::string border_frame = border.getHorizontalFrame();
  {
    ...
    if (!ret) {
      RCLCPP_WARN(node_->get_logger(),
                  "Could not transform the first point in the path");
      return false;
    }
...
bool SafetyAreaManager::isPathToPointInSafetyArea3d(
    const mrs_msgs::msg::ReferenceStamped& start,
    const mrs_msgs::msg::ReferenceStamped& end) {
  if (!safety_zone_handler_.safety_zone->safetyZoneEnabled()) {
    return true;
...
double SafetyAreaManager::getMaxZ() {
  ...
  if (!safety_zone_handler_.safety_zone ||
      !safety_zone_handler_.safety_zone->safetyZoneEnabled()) {
...

  {
    ...
    if (sh_max_z_.hasMsg()) {
      ...
      if (!ret) {
        RCLCPP_WARN(node_->get_logger(),
                    "Could not transform estimation manager's max_z to the "
...
void SafetyAreaManager::publishDiagnostics(void) {
  ...
  mrs_lib::ScopeTimer timer =
      mrs_lib::ScopeTimer(node_, "SafetyAreaManager::publishDiagnostics",
                          scope_timer_logger_, scope_timer_enabled_);
  ...
  auto world_origin_units = mrs_lib::get_mutexed(
      mutex_safety_area_, safety_zone_handler_.parameters.world_origin.units);
  auto origin_x = mrs_lib::get_mutexed(
      mutex_safety_area_, safety_zone_handler_.parameters.world_origin.x);
  auto origin_y = mrs_lib::get_mutexed(
      mutex_safety_area_, safety_zone_handler_.parameters.world_origin.y);

  diagnostics_msg.stamp = clock_->now();
  diagnostics_msg.uav_name = _uav_name_;
  auto [is_position_valid_2d, is_position_valid_3d] =
      isPositionValid(uav_state);
  ...
  // | -------------- fill in the safety zone data -------------- |
  {
    ...
    // Enable flag
    diagnostics_msg.safety_area_enabled =
        safety_zone_handler_.safety_zone->safetyZoneEnabled();

    if (!safety_zone_handler_.safety_zone) {
      RCLCPP_WARN_THROTTLE(node_->get_logger(), *node_->get_clock(), 5000,
                           "No safety border defined.");
    ...
    diagnostics_msg.border.horizontal_frame =
        safety_border.getHorizontalFrame();
    ...
    const auto& obstacles_ptrs =
        safety_zone_handler_.safety_zone->getObstacles();

    diagnostics_msg.obstacles_present =
        obstacles_ptrs.size() == 0 ? false : true;
...
std::tuple<bool, bool> SafetyAreaManager::isPositionValid(
  ...
  RCLCPP_INFO_STREAM_ONCE(node_->get_logger(),
                          "Initial current position x:  "
                              << current_position.reference.position.x << " y: "
                              << current_position.reference.position.y << " z: "
...
RCLCPP_COMPONENTS_REGISTER_NODE(
    mrs_uav_managers::safety_area_manager::SafetyAreaManager)
